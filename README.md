vagrant-hadoop-2.4.1-spark-1.6.0
================================

# Introduction

Vagrant project to spin up a cluster of 4 virtual machines with Hadoop v2.4.1 and Spark v1.6.0. 
...
2. /resources/spark-1.6.0-bin-hadoop2.4.tgz
3. /resources/jdk-7u80-linux-x64.tar.gz
